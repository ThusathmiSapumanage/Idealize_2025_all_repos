...
public class DonorAuthService {
    ...
    public String registerDonor(DonorRegistrationRequest request, MultipartFile userImage) throws IOException {
        ...
        if (userImage != null && !userImage.isEmpty()) {
            ...
            donor.setUserImage(null);
            donor.setImageType(null);
        }
    ...
    public String loginDonor(String userEmail, String password) {
        Donor donor = donorRepository.findByUserEmail(userEmail)
